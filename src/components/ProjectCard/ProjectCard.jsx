...
function ProjectCard({
  ...
  return (
    <Col sm={6} md={4}>
      <Card className="project-card mt-3">
        <Card.Img
        ...
        <Card.Body>
          ...
          <div
            className="technologies-stack mt-4"
      ...
      <ModalMessageComponents
        ...
        title="This project is built with pure WordPress"
      >
        <p>
          The source code of <span className="fw-semibold">{title}</span> is not
          available on GitHub because this project was created using pure
          WordPress without custom coding.
        </p>
      </ModalMessageComponents>
    </Col>
  );
